...
Write a professional yet accessible health analysis report in **Korean**. The report must include:

**SECTION 1: 게임별 상세 분석 (Game Analysis)**
...
**SECTION 2: 디지털 치매 위험도 평가 (Digital Dementia Risk Assessment)**
...
**SECTION 3: 맞춤형 뇌 건강 처방 (Actionable Advice)**
